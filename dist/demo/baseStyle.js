...
var _a = createTypeStyle_1.createTypeStyle(React.createElement), cssRule = _a.cssRule, cssRaw = _a.cssRaw, style = _a.style, keyframes = _a.keyframes, getStyles = _a.getStyles, setStylesTarget = _a.setStylesTarget, prepare = _a.prepare, mergeStyles = _a.mergeStyles, googleFont = _a.googleFont, setupMount = _a.setupMount, makeComponent = _a.makeComponent;
...
var mount = setupMount(react_dom_1.render);
exports.mount = mount;
